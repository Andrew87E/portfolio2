...
export default function Contact() {
  ...
  return (
    <Page
      currentPage="Contact"
      meta={{
        title: "Contact - Andrew Edwards | Get in Touch",
        desc: "Get in touch with Andrew Edwards. Whether you have a project in mind or just want to connect, I'm always open to discussing new opportunities and ideas.",
      }}
