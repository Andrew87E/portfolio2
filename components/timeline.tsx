...
export const Timeline = (props: Props) => {
  return (
    <section className="w-fullmx-auto text-black dark:text-white font-lobster text-3xl">
      <div className="mx-auto text-center">
        {/* <div className="mx-auto w-24 h-1 mb-5 bg-secondary"></div> */}
      </div>
      <div className="w-10/12 max-w-2xl mx-auto text-black dark:text-white font-lobster text-xl">
