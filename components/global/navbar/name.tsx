        ...
        <span className="text-2xl flex items-center">
          ...
          {"Andrew".split("").map((letter, index) => {
            return (
              <span
                key={index}
                className="cursor-pointer transition-all duration-700 hover:duration-100 hover:scale-125 hover:translate-y-1 hover:text-lime-500 text-black ae-name font-header"
              >
                {letter}
              </span>
            );
